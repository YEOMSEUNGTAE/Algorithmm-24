    ...
    def view_reservations(self):
        ...
        if not reservations:
            ...
            for i, reservation in enumerate(reservations):
                ...
                ttk.Label(self.main_frame, tsext=reservation_details).grid(row=i, column=0, pady=10)
                # 뒤로 가기 버튼
